...
public class SaveImageToFileWorker extends Worker {
    ...
    private static String TITLE = "Blurred Image";
    private static SimpleDateFormat DATE_FORMATTER = new SimpleDateFormat("yyyy.MM.dd 'at' HH:mm:ss z", Locale.getDefault());
